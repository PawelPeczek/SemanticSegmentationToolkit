...
class ThinModelV2(SemanticSegmentationModel):
    ...
    def run(self, X, num_classes, training=True):
        ...
        bn_5_a = tf.layers.batch_normalization(dil_3_3, is_training=training)
        ...
        bn_8_a = tf.layers.batch_normalization(dil_4_3, is_training=training)
        dil_4_4 = self.__dilated_block(bn_8_a)
        bn_8_b = tf.layers.batch_normalization(dil_4_4, is_training=training)
